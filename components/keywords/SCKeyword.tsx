    ...
    >
      <div className=" w-3/4 lg:flex-1 lg:basis-20 lg:w-auto font-semibold cursor-pointer">
        <button
          ...
          onClick={(event) => !isTracked && selectKeyword(uid, event)}
        >
          <Icon
            type="check"
            size={10}
            title={isTracked ? 'Already in Tracker' : ''}
          />
        </button>
      ...
      <div
        className={
          'keyword_visits text-center inline-block mt-4 mr-5 ml-5 lg:flex-1 lg:m-0 max-w-[70px] lg:max-w-none lg:pr-5'
        }
      >
        <span className="mr-3 lg:hidden">
