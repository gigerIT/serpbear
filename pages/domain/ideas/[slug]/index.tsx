...
const DiscoverPage: NextPage = () => {
  ...
  const adwordsConnected = !!(appSettings &&
  ...
  const {
    ...
    isError: errorLoadingIdeas,
  } = useFetchKeywordIdeas(router, adwordsConnected);
    ...
    <div className="Domain ">
        ...
        <div className="domain_keywords px-5 pt-10 lg:px-0 lg:pt-8 w-full">
          {activDomain && activDomain.domain ? (
            <DomainHeader
              ...
              exportCsv={() =>
                exportKeywordIdeas(
                  showFavorites ? favorites : keywordIdeas,
                  activDomain.domain
                )
              }
      ...
      {showUpdateModal && activDomain?.domain && (
        <Modal
          ...
          title={"Load Keyword Ideas from Google Ads"}
          verticalCenter={true}
        >
          <KeywordIdeasUpdater
            domain={activDomain}
